 ...
 *
 * (:Empeg Source Release 1.13.2.2 01-Apr-2003 18:52 rob:)
 */
...
struct DynamicData1
{
    ...
    time_t		play_last;	/* last time played */
...
/* Fields in 'bpm_data' */
#define BPM_BPM_MASK    0x000003ff      /* actual BPM multiplied by 4 */
#define BPM_BIN_MASK    0x0007fc00      /* see bpm_monitor.cpp */
#define BPM_AMP_MASK    0xfff80000      /* see bpm_monitor.cpp */
