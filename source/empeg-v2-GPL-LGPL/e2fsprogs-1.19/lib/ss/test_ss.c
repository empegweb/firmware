 ...
 *------------------------------------------------------------------
 *
 * $Source: /tramp/usr/src/CVS-REPO/e2fsprogs/lib/ss/test_ss.c,v $
 * $Revision: 1.13 $
...
static char const rcsid_test_c[] =
    "$Header: /tramp/usr/src/CVS-REPO/e2fsprogs/lib/ss/test_ss.c,v 1.13 1997/04/29 21:26:37 tytso Exp $";
#endif /* lint */
