 ...
 *------------------------------------------------------------------
 *
 * $Source: /mit/tytso/linux/CVS-REPO/e2fsprogs/lib/ss/test_ss.c,v $
 * $Revision: 1.13 $
 * $Date: 1997/04/29 21:26:37 $
 * $State: Exp $
 * $Author: tytso $
 * $Locker:  $
 *
...
static char const rcsid_test_c[] =
    "$Header: /mit/tytso/linux/CVS-REPO/e2fsprogs/lib/ss/test_ss.c,v 1.13 1997/04/29 21:26:37 tytso Exp $";
#endif /* lint */
