...
__initfunc(int chr_dev_init(void))
{
...
#ifdef CONFIG_SA1100_EMPEG
	{
		...
		extern int empeg_state_init(void);
		extern int empeg_rds_init(void);
	...
	{
	  extern int kb_victor_init( void );
	  extern int audio_sa1100_ssp_init( void );

	  kb_victor_init();
	  audio_sa1100_ssp_init();
	}
#endif
	...
	{
	  extern int sa1100_mcp_common_init( void );
	  extern int audio_sa1100_mcp_init( void );

	  sa1100_mcp_common_init();
	  audio_sa1100_mcp_init();
	}
#endif
